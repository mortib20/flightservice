...
if [ "$ARCH" == "x86_64" ]; then
    #wget -c https://repo-feed.flightradar24.com/linux_x86_64_binaries/fr24feed_1.0.44-0_amd64.tgz -O - | tar -xz
    wget -c https://repo-feed.flightradar24.com/linux_binaries/fr24feed_1.0.44-0_amd64.tgz -O - | tar -xz
